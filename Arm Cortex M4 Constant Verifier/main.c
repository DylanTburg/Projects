...
int main()
{
    ...
    int j = 0;
    char a[9];
    printf("Pick an eight digit number, using zeros if necessary, in hex to test. No '0x' prefix: ");
    scanf("%s", a);
    ...
    if(x == 0xffffffff) //Determines if number is FFFFFFFF which is allowed
    {
        printf("%s can be used in ARM", a);
        return 0;
    }
